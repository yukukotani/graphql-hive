...
import migration_2023_08_03T11_44_36_schema_checks_github_repository from './actions/2023.08.03T11.44.36.schema-checks-github-repository';
...
export const runPGMigrations = (args: { slonik: DatabasePool; runTo?: string }) =>
  runMigrations({
    ...
    migrations: [
      ...
      migration_2023_08_03T11_44_36_schema_checks_github_repository,
    ],
  });
